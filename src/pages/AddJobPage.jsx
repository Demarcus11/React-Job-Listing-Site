...
const AddJobPage = ({ addJob }) => {
  ...
  const handleAddJobFormSubmit = (e) => {
    ...
    // after the form submission is successful, redirect to "/jobs"
            ...
            <form onSubmit={handleAddJobFormSubmit}>
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  required
                  value={job.type}
                  // the reason you need parenthesis around the: ({ ...prev, type: e.target.value }), is because it's an arrow function and '{}' it apart of the arrow function syntax, so we gotta wrap the object in parenthsis to indicate its an object and not function brackets
                  onChange={(e) => setJob((prev) => ({ ...prev, type: e.target.value }))} // Getting the selected <option> element's value attribute
                >
